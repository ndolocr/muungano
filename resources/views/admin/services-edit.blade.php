                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('name', $service->name, ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Service Name']) }}
                                    </div>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        {{ Form::textarea('description', $service->description, ['class' => 'ckeditor form-control', 'id' => 'description']) }}
                                    </div>
