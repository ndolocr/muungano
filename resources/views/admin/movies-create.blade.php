...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <!-- BEGIN FORM CREATION -->
            {!! Form::Open( ['action' => 'adminMovieController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data'] ) !!}
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('title', '', ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Movie Title']) }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::number('year_released', '', ['class' => 'form-control', 'id' => 'year_released', 'placeholder' => 'Year Released']) }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::number('duration', '', ['class' => 'form-control', 'id' => 'duration', 'placeholder' => 'Movie Duration']) }}
                                    </div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('classification', '', ['class' => 'form-control', 'id' => 'classification', 'placeholder' => 'Movie Classification']) }}
                                    </div>
