                ...
                <tbody>
                    ...
                    <tr>    
                        <td style="text-align: center;">
                            <a href="{{ route('home-page-header') }}" class='btn green btn-outline sbold uppercase'> Cancel  </a>
                        </td>
                        <td> 
                            {!! Form::open(['action'=>['AdminController@homePageHeaderDestroy', $data->id], 'method'=>'POST']) !!}
